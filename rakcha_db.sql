...
(3, 'Zendaya', '/img/actors/3033.jpg', 'Zendaya Coleman, dite simplement Zendaya, est une actrice, productrice,
        mannequin, '),
...
(5, 'Robert Downey Jr', '/img/actors/15329.jpg', 'Robert Downey Jr. /ˈɹɑbɚt ˈdaʊni ˈd͡ʒunjɚ/,
        né le 4 avril 1965 à New York, est un acteur et scénariste américain.'),
...
(9, 'Tom Hardy', '/img/actors/23056.jpg', 'Edward Hardy, dit Tom Hardy,
        né le 15 septembre 1977 à Hammersmith en Angleterre, est un acteur et producteur britannique');
...
(2, 'POSTER', 'Transform your walls into a movie buff\'s dream gallery with our unique cinematic paintings'),
       (3, 'Sculptures',
        'Sculptures are three-dimensional works of art to represent shapes, figures or artistic objects.'),
...
VALUES (1, 'Action', 'Des films remplis d\'aventures, de combats,
        de cascades et d\'exploits héroïques. Ils mettent souvent en avant des personnages principaux confrontés à des défis physiques ou à des situations dangereuses.'),
       (2, 'Adventure',
        'Movies that involve exciting journeys, exploration of new territories, and often include elements of danger, discovery, and heroism.'),
       (3, 'Comedy',
        ' Films designed to entertain and amuse through humor, wit, and exaggerated situations, often aiming to provoke laughter from the audience.'),
       (4, 'Drama',
        'Movies focused on realistic characters and their emotional struggles, often exploring themes such as love, loss, conflict, and personal growth.'),
       (5, 'Horror',
        'Films intended to evoke fear, disgust, or shock in the audience through suspenseful storytelling, supernatural elements, or gruesome imagery.'),
       (6, 'Science Fiction',
        'Movies set in speculative futures or alternative realities, often featuring advanced technology, space exploration, and imaginative concepts about the universe.'),
       (7, 'Fantasy',
        'Films that incorporate magical or supernatural elements, mythical creatures, and imaginative worlds, often drawing inspiration from folklore, mythology, or fantasy literature.'),
       (8, 'Thriller',
        'Movies characterized by suspenseful and tense narratives, often involving crime, espionage, or psychological gamesmanship, aimed at keeping the audience on the edge of their seats.'),
       (9, 'Mystery',
        'Films that revolve around solving a puzzle or uncovering secrets, typically involving a detective or amateur sleuth as the central character.'),
       (10, 'Romance',
        'Movies centered on love stories and romantic relationships, often featuring themes of passion, longing, and emotional connection between characters.'),
       (11, 'Animation',
        'Films created using animation techniques, including traditional hand-drawn animation, computer-generated imagery (CGI), or stop-motion animation, appealing to audiences of all ages.'),
       (12, 'Musical',
        'Movies that incorporate song and dance sequences as integral parts of the narrative, often featuring characters expressing their emotions or advancing the plot through music.'),
       (13, 'Documentary',
        'Non-fiction films that aim to educate, inform, or raise awareness about real-life subjects, events, or issues, often employing interviews, archival footage, and voice-over narration.'),
       (14, 'Biography',
        'Films based on the lives of real people, exploring their achievements, struggles, and significant moments, often offering insights into their personal and professional journeys.'),
       (15, 'Historical',
        'Movies set in the past, depicting historical events, figures, or periods, often blending factual accuracy with dramatic storytelling to recreate historical moments.');
...
(16, 'L\'AGORA', 'Sousse', 104, 'img/cinemas/agora-logo.png-6638419a730b9.png', 'Pending'),
       (18, 'ABC Cinema', 'Monastir', 104, 'img/cinemas/5db23739-d572-4b26-9031-996a1e6b49a4.jpeg-663841e1de710.jpg',
        'Pending'),
...
VALUES ('DoctrineMigrations\\Version20240501104445', '2024-05-01 12:45:51', 270),
...
INSERT INTO `evenement` (`id_categorie`, `ID`, `nom`, `dateDebut`, `dateFin`, `lieu`, `etat`, `description`,
                         `affiche_event`)
VALUES (1, 1, 'SuperManProjection', '2019-01-01', '2019-01-06', 'Esprit', 'Incoming', 'JoinUsToWatchSpiderManInEsprit',
        'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3Dz'),
       (1, 2, 'HollywoodMovie', '2024-05-01', '2024-05-02', 'Esprit', 'Incoming', 'ThisIsAMovieProjection !',
       ...
       (2, 3, 'LetsDebate', '2024-05-01', '2024-05-03', 'Esprit', 'Ongoing', 'This is a movie debate !',
        'https://images.unsplash.com/photo-1544531586-fde5298cdd40?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'),
       (3, 4, 'PartyNow', '2021-05-01', '2021-05-03', 'Esprit', 'Incoming', 'this is a party',
        'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3Dz');
...
(7, 'SpiderMan No Way Home', '/img/films/61459.jpg', '02:28:30', 'Avec l\'identité de Spiderman désormais révélée, celui-ci est démasqué',
        2021, 1),
       (8, 'Avengers  Infinity War', '/img/films/6794.jpg', '02:29:41',
        'Alors que les Avengers et leurs alliés ont continué de protéger le monde face à des menaces bien trop grande',
        2018, 1),
...
(10, 'Venom Let There Be Carnage', '/img/films/62047.jpg', '01:37:42', 'Après leur triomphe sur Riot,
        Eddie Brock et son parasite extraterrestre se sont mis d\'accord sur quelques règles de conduite', 2021, 0),
       (11, 'LIdee detre avec toi', '/img/films/79595.jpg', '01:55:36',
        'Lorsque Solène, une mère célibataire de 40 ans, doit chaperonner le voyage de sa fille adolescente au festival de musique de Coachella,',
        2024, 0),
       (12, 'Dachra', '/img/films/39862.jpg', '01:32:56',
        'Dachra est un film d\'horreur tunisien écrit et réalisé par Abdelhamid Bouchnak et sorti en 2018', 2018, 0),
(13, 'Titanic', '/img/films/43943.jpg', '03:23:40', 'Southampton,
        10 avril 1912. Le paquebot le plus grand et le plus moderne du monde, réputé pour son insubmersibilité,
        le « Titanic »', 2008, 0),
(14, ' En eaux tres troubles ', ' / img / films / 82547. jpg ', ' 01: 58 : 15 ', ' Une équipe de chercheurs en pleine
        opération d\'extraction minière illégale dans l\' océan se retrouve en péril.', 2023, 0);
...
(1, ' Smoking Joker Pop Art ', 50, ' img / produit / smokingjoker.jpg - 6633cbcd85b2d.jpg ', ' Printed on thick paper (
...
(2, ' Le Parrain ', 170, ' img / produit / leparrain.jpg - 6633cbee570e0.jpg ', ' Printing on thick paper (250 g / m²)\r\nÉclat
        maximal des couleurs et haute résistance aux UV ', 92, 2),
(3, ' OLD TIMES ', 150, ' img / produit / oldtimes.jpg - 6633cbff937c8.jpg ', ' Limited edition (n°2/ 5) Sculpture,
...
ALTER TABLE `film_actor`
  ...
  ADD CONSTRAINT `FK_DD19A8A9567F5183` FOREIGN KEY (`film_id`) REFERENCES `film` (`id`) ON
DELETE
CASCADE;
...
ALTER TABLE `film_category`
  ...
  ADD CONSTRAINT `FK_A4CBD6A8567F5183` FOREIGN KEY (`film_id`) REFERENCES `film` (`id`) ON
DELETE
CASCADE;
...
ALTER TABLE `seance`
  ...
  ADD CONSTRAINT `FK_DF7DFD0EA0123F6C` FOREIGN KEY (`id_salle`) REFERENCES `salle` (`id_salle`) ON
DELETE
CASCADE,
