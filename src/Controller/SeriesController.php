...
class SeriesController extends AbstractController
{
    ...
    public function index(SeriesRepository $seriesRepository): Response
    {
        ...
        return $this->render('series/seriesTables.html.twig', [
...
#[Route('/series/statistics', name: 'app_series_statistics', methods: ['GET'])]
public function seriesStatistics(EntityManagerInterface $entityManager): Response
{
    // Récupérer les statistiques des séries par catégorie
    $statisticsData = $this->getDoctrine()->getRepository(Series::class)->getStatisticsByCategory($entityManager);

    // Rendre la vue des statistiques avec les données générées
    return $this->render('series/statistics.html.twig', [
