 ...
 */
final class Version20240502191446 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE filmcinema (id_film INT NOT NULL, id_cinema INT NOT NULL, INDEX fk_fc2 (id_cinema), INDEX fk_fc1 (id_film), PRIMARY KEY(id_film, id_cinema)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
